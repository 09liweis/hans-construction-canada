  ...
  <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center h-16">
      ...
      <a href="/" class="flex items-center">
        <span class="text-2xl font-bold text-orange-600">Hans Construction</span>
      </a>
      ...
      <div class="hidden md:flex items-center space-x-8">
        <a 
          href="/" 
          class="text-gray-700 hover:text-orange-600 font-medium transition-colors duration-200 {$page.url.pathname === '/' ? 'text-orange-600' : ''}"
        >
          Home
        </a>
        <a 
        ...
        <a 
          href="/contact" 
          class="text-gray-700 hover:text-orange-600 font-medium transition-colors duration-200 {$page.url.pathname.includes('contact') ? 'text-orange-600' : ''}"
        >
          Contact
        </a>
        <a 
      ...
      <!-- Mobile menu button -->
      <button class="md:hidden p-2" aria-label="Toggle mobile menu">
