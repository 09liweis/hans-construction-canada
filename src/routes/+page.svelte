		...
		<div class="grid lg:grid-cols-2 gap-12 items-center">
			...
			<div class="text-center lg:text-left">
				<div class="inline-flex items-center px-4 py-2 bg-orange-500/10 border border-orange-500/20 rounded-full mb-6">
					<span class="text-orange-400 text-sm font-medium">🏗️ Licensed & Insured • 25+ Years Experience</span>
				</div>
				
				<h1 class="text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
					Building <span class="text-orange-500">Excellence</span> Across Canada
				</h1>
				
				<p class="text-xl text-gray-300 mb-8 leading-relaxed max-w-2xl">
					Trusted construction professionals delivering superior craftsmanship, innovative solutions, and exceptional value for residential and commercial projects since 1995.
				</p>
			...
			<div class="grid grid-cols-2 gap-6">
				...
				<div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 text-center">
					...
					<div class="text-gray-400 text-sm mt-1">Since 1995</div>
				</div>
				<div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 text-center">
	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="text-center mb-16">
			...
			<p class="text-xl text-gray-600 max-w-3xl mx-auto">
				Comprehensive construction solutions tailored to meet your specific needs with precision and excellence.
			</p>
		</div>
		...
		<div class="grid md:grid-cols-3 gap-8">
			...
			<div class="group relative bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 hover:border-orange-500">
				...
				<h3 class="text-2xl font-bold text-gray-900 mb-4">Residential Construction</h3>
			...
			<div class="group relative bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 hover:border-orange-500">
				...
				<h3 class="text-2xl font-bold text-gray-900 mb-4">Commercial Projects</h3>
				<p class="text-gray-600 mb-6">
			...
			<div class="group relative bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 hover:border-orange-500">
				...
				<h3 class="text-2xl font-bold text-gray-900 mb-4">Renovations & Remodeling</h3>
				<p class="text-gray-600 mb-6">
...
<section class="py-20 bg-gradient-to-r from-orange-600 to-red-600">
	<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
		...
		<div class="flex flex-col sm:flex-row gap-4 justify-center">
			<button class="px-8 py-4 bg-white text-orange-600 font-semibold rounded-lg hover:bg-gray-100 transition-all duration-300 shadow-lg">
				Get Free Quote
			</button>
			<button class="px-8 py-4 bg-transparent border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-orange-600 transition-all duration-300">
